...
var _axios = require("axios"); // importar la libretía
...
(0, _axiosDefault.default).get("https://api.github.com/orgs/lemoncode/members").then((response)=>{
    ...
    for (let item of data)document.write(item.login);
}).catch((error)=>{
...
var Buffer = require("1f1294a556773996").Buffer;
"use strict";
/**
...
},{"1f1294a556773996":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("1504d2f7c95ada90");
var ieee754 = require("d2e191b9db7398c3");
...
},{"1504d2f7c95ada90":"eIiSV","d2e191b9db7398c3":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
