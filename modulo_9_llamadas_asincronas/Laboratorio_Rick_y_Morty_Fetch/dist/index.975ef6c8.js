...
_dataBusiness.getCharacter().then((data)=>{
    document.getElementById("root").innerText = ""; // Para limpiar lo que ya hay en el html
    const character = data;
    const nodes = [];
    for (item of character){
        const node = _utilsJs.createCharacterRow(item);
        const char_id = _dataBusiness.getCharacterByIdid(item.id);
        node.onclick = function() {
            char_id.then((data)=>{
                _utilsJs.showCharacter(data);
            });
        };
        nodes.push(node);
    }
...
},{}],"6IOkp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequirebdb5")
