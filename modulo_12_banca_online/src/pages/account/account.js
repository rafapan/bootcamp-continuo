...
const isEditMode = Boolean(params.id); //Boolean de js, te dice si es verdadero o falso es igual que !!. Si existe ese parámetro vemos en la url que estamos en modo edición de la cuenta.
