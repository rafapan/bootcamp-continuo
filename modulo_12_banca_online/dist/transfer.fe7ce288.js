...
var onUpdateField = exports.onUpdateField = function onUpdateField(id, callback) {
  ...
  }; // oninput recoge la información del usuario cuando teclea
...
var validator$1 = exports.iban = /*#__PURE__*/Object.freeze({
  __proto__: null,
  setErrorMessage: setErrorMessage,
  validator: validator
});
...
exports.myValidatorYear = exports.myValidatorMonth = exports.myValidatorDay = void 0;
var validatorToday = 'Day validations';
var today = new Date();
...
var myValidatorYear = exports.myValidatorYear = function myValidatorYear(theYear) {
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","./trasnfer.custom.validators":"pages/transfer/trasnfer.custom.validators.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var insertTransfer = exports.insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post("".concat(urlTransfer, "/").concat(transfer.id), transfer).then(function (response) {
    return response.data;
  });
};
var getTransfer = exports.getTransfer = function getTransfer() {
