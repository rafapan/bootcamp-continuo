...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  _uploadProperty.formValidation.validateField('title', formUpload.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty.formValidation.validateField('notes', formUpload.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty.formValidation.validateField('email', formUpload.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty.formValidation.validateField('phone', formUpload.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty.formValidation.validateField('price', formUpload.price).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty.formValidation.validateField('address', formUpload.address).then(function (result) {
...
},{"../../core/router/history":"core/router/history.js","../../common/helpers":"common/helpers/index.js","./upload-property.validations":"pages/upload-property/upload-property.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
