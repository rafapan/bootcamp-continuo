...
exports.mapPropertyDetailsFromApiToVM = void 0;
var mapPropertyDetailsFromApiToVM = exports.mapPropertyDetailsFromApiToVM = function mapPropertyDetailsFromApiToVM(propertyDetails) {
...
if (isId) {
  Promise.all([(0, _propertyDetail2.getEquipmentList)()]).then(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
      equipmentList = _ref2[0];
    (0, _propertyDetail2.getPropertyDetails)(params.id).then(function (apiProperty) {
      apiProperty.map(function (eachProperty) {
        if (params.id == eachProperty.id) {
          var myEquipmentsIds = eachProperty.equipmentIds;
          eachProperty.equipments = getMyEquipments(equipmentList, myEquipmentsIds);
          propertyDetail = (0, _propertyDetail3.mapPropertyDetailsFromApiToVM)(eachProperty);
          (0, _propertyDetail.setPropertyValues)(propertyDetail);
        }
      });
    });
  });
...
(0, _helpers.onSubmitForm)('contact-button', function () {
  _propertyDetail4.formValidation.validateForm(contact).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _propertyDetail2.insertMessage)(contact);
